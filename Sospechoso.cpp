...
Sospechoso::Sospechoso(string nombre,bool principal,bool culpable,bool victima)
:nombre(nombre),principal(principal),culpable(culpable),victima(victima){

}
Sospechoso::Sospechoso(const Sospechoso& other):
nombre(other.nombre), principal(other.principal), culpable(other.culpable), victima(victima){
